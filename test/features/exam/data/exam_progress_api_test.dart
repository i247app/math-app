...
void main() {
  test('exam progress accepts a null average delta', () {
    final response = ExamProgressResponseDto.fromJson(<String, dynamic>{
      ...
      'series': <Map<String, dynamic>>[
        <String, dynamic>{
          'last_submitted_dt': '2026-08-14T10:05:32.716344Z',
          'correct_number': 2,
          'exam_type': 'ASSESSMENT',
          'grade': 1,
          'level': 1,
        ...
        <String, dynamic>{
          'last_submitted_dt': '2026-08-14T10:07:16.946980Z',
          'correct_number': 2,
          'exam_type': 'ASSESSMENT',
          'grade': 1,
          'level': 2,
  ...
  test('exam progress posts journey dates and parses the summary', () async {
    String? requestPath;
        ...
        onRequest: (options, handler) {
          ...
          handler.resolve(
            Response<Object?>(
              ...
              statusCode: 200,
              data: <String, dynamic>{
                'from_dt': '2026-01-03 04:48:58.607719',
                'limit': 10,
                'mstatus': 200,
                'profile_id': 21,
                'series': <Map<String, dynamic>>[
                  <String, dynamic>{
                    'last_submitted_dt': '2026-07-28T06:15:28.136337Z',
                    'correct_number': 4,
                    'exam_type': 'ASSESSMENT',
                    'grade': 1,
                    'level': 1,
                ...
                'to_dt': '2026-08-03 04:48:58.607719',
                'tz': '+07:00',
              },
            ),
          );
    ...
    expect(requestPath, '/exams/journey/progress');
    ...
    expect(requestBody, containsPair('from_dt', '2026-01-03 04:48:58.607719'));
    expect(requestBody, containsPair('to_dt', '2026-08-03 04:48:58.607719'));
    expect(response.series.single.examId, 62);
    expect(response.series.single.score, 8);
    expect(response.series.single.scorePct, 80);
    expect(response.series.single.grade, 1);
    expect(response.series.single.status, 'COMPLETE');
    expect(response.summary?.averageDelta, -1.8);
    expect(response.summary?.highestExamId, 62);
