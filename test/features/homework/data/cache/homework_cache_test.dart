...
void main() {
  ...
  test('student homework list request completes', () async {
    ...
    final result = await StudentHomeworkCache.loadList(
      service: service,
      classroomId: 9101,
      profileId: 9101,
      forceRefresh: true,
  ...
  test('student homework detail request completes', () async {
    ...
    final result = await StudentHomeworkCache.loadDetail(
      service: service,
      exerciseId: 9102,
      profileId: 9102,
      forceRefresh: true,
  ...
  test('teacher homework list request completes', () async {
    ...
    final result = await TeacherHomeworkCache.loadList(
      service: service,
      classroomId: 9103,
      profileId: 9103,
  ...
  test('teacher homework detail request completes', () async {
    ...
    final result = await TeacherHomeworkCache.loadDetail(
      service: service,
      exerciseId: 9104,
      profileId: 9104,
      forceRefresh: true,
