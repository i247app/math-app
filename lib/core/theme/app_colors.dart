...
abstract final class AppColors {
  ...
  static const tealDark = Color(0xFF00665F);
  static const aquaMist = Color(0xFFBFECEF);
  static const mintMist = Color(0xFFEFFAE8);
  static const skyMint = Color(0xFFCFF7F7);
  static const mintPanel = Color(0xFFDDEFD9);
  static const mintInput = Color(0xFFD0E6CD);
