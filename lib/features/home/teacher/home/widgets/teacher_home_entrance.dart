...
class _TeacherHomeEntrance extends StatefulWidget {
  const _TeacherHomeEntrance({
    super.key,
    required this.order,
    required this.child,
    this.onFinished,
  ...
  @override
  State<_TeacherHomeEntrance> createState() => _TeacherHomeEntranceState();
}

class _TeacherHomeEntranceState extends State<_TeacherHomeEntrance> {
