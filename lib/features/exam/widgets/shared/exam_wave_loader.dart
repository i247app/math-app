...
class ExamWaveLoader extends StatefulWidget {
  const ExamWaveLoader({
    super.key,
  ...
  @override
  State<ExamWaveLoader> createState() => _ExamWaveLoaderState();
}

class _ExamWaveLoaderState extends State<ExamWaveLoader>
