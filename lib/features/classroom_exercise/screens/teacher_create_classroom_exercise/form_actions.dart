part of '../teacher_create_classroom_exercise_screen.dart';

extension _TeacherCreateClassroomExerciseFormActions
    on _TeacherCreateClassroomExerciseScreenState {
  Future<void> _submit() async {
    if (_isSubmitting) {
      return;
    }

    if (!_validateCreateClassroomExerciseForm()) {
      return;
    }
  ...
  bool _validateCreateClassroomExerciseForm() {
