...
import 'package:numi/features/classroom_exercise/widgets/teacher_detail/teacher_assignment_detail_helpers.dart';
import 'package:numi/features/classroom_exercise/widgets/teacher_detail/teacher_assignment_info_card.dart';
import 'package:numi/features/classroom_exercise/widgets/teacher_detail/teacher_question_card.dart';
import 'package:numi/features/classroom_exercise/widgets/teacher_list/teacher_exercise_copy.dart';

class TeacherClassroomExerciseDetailScreen extends StatefulWidget {
  const TeacherClassroomExerciseDetailScreen({
    super.key,
  ...
  @override
  State<TeacherClassroomExerciseDetailScreen> createState() =>
      _TeacherClassroomExerciseDetailScreenState();
}
...
class _TeacherClassroomExerciseDetailScreenState
  ...
  Future<void> _loadDetail({bool forceRefresh = false}) async {
    if (!forceRefresh) {
      final cachedExercise = TeacherClassroomExerciseCache.peekDetail(
    ...
    try {
      final exercise = await TeacherClassroomExerciseCache.loadDetail(
  ...
  Future<void> _saveVisibility() async {
    ...
    try {
      ...
      if (updated != null) {
        TeacherClassroomExerciseCache.replaceDetail(
          profileId: widget.profileId,
          exercise: updated,
        );
      }
