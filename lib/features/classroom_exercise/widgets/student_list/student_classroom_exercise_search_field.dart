...
class StudentClassroomExerciseSearchField extends StatelessWidget {
  const StudentClassroomExerciseSearchField({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return AppSearchField(
      ...
      hintText: context.getText(AppKeys.studentClassroomExerciseSearchHint),
      onChanged: onChanged,
