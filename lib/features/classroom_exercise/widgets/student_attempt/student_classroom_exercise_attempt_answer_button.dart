...
class StudentClassroomExerciseAttemptAnswerButton extends StatelessWidget {
  const StudentClassroomExerciseAttemptAnswerButton({
    super.key,
  ...
  final StudentClassroomExerciseAttemptAnswer answer;
  final bool selected;
