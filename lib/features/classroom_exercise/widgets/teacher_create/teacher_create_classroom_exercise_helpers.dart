...
String? formatCreateClassroomExerciseDate(DateTime? value) {
  if (value == null) {
    return null;
  }
...
String createClassroomExerciseClassName(
...
String createClassroomExerciseClassSummaryName(
  BuildContext context,
  ClassroomModel? classroom,
) {
  final name = classroom?.name?.trim();
...
String createClassroomExerciseStudentCount(
  BuildContext context,
  ClassroomModel? classroom,
) {
...
String createClassroomExerciseGradeName(
  BuildContext context,
  ClassroomModel? classroom,
...
String createClassroomExerciseProgramName(
  BuildContext context,
  ClassroomModel? classroom,
...
String? selectedClassroomExerciseProgramName(
  BuildContext context,
  List<ProgramModel> programs,
  int? selectedProgramId,
) {
...
String createClassroomExerciseSchoolName(
  BuildContext context,
  ClassroomModel? classroom,
