...
class TeacherClassroomExerciseCache {
  TeacherClassroomExerciseCache._();

  static final Map<_TeacherClassroomExerciseListKey, List<ClassroomExercise>>
  _lists = <_TeacherClassroomExerciseListKey, List<ClassroomExercise>>{};
  static final Map<
    _TeacherClassroomExerciseListKey,
    Future<List<ClassroomExercise>>
  >
  _pendingLists =
      <_TeacherClassroomExerciseListKey, Future<List<ClassroomExercise>>>{};
  static final Map<_TeacherClassroomExerciseDetailKey, ClassroomExercise?>
  _details = <_TeacherClassroomExerciseDetailKey, ClassroomExercise?>{};
  static final Map<
    _TeacherClassroomExerciseDetailKey,
    Future<ClassroomExercise?>
  >
  _pendingDetails =
      <_TeacherClassroomExerciseDetailKey, Future<ClassroomExercise?>>{};
  ...
  static Future<List<ClassroomExercise>> loadList({
    ...
    final key = _TeacherClassroomExerciseListKey(
    ...
    request = service
        ...
        .then((exercises) {
          ...
          for (final exercise in cachedExercises) {
            ...
            if (exerciseId != null) {
              _details[_TeacherClassroomExerciseDetailKey(
                    profileId: profileId,
  ...
  static List<ClassroomExercise>? peekList({
    ...
    return _lists[_TeacherClassroomExerciseListKey(
      classroomId: classroomId,
      profileId: profileId,
      purpose: purpose,
    )];
  ...
  static Future<ClassroomExercise?> loadDetail({
    ...
    final key = _TeacherClassroomExerciseDetailKey(
      profileId: profileId,
      exerciseId: exerciseId,
    );
  ...
  static ClassroomExercise? peekDetail({
    ...
    return _details[_TeacherClassroomExerciseDetailKey(
      profileId: profileId,
      exerciseId: exerciseId,
    )];
  }
...
class _TeacherClassroomExerciseListKey {
  _TeacherClassroomExerciseListKey({
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is _TeacherClassroomExerciseListKey &&
...
class _TeacherClassroomExerciseDetailKey {
  const _TeacherClassroomExerciseDetailKey({
    required this.profileId,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is _TeacherClassroomExerciseDetailKey &&
            other.profileId == profileId &&
