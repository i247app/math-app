...
class StudentClassroomExerciseCache {
  StudentClassroomExerciseCache._();

  static const _emptyDetailRetryDelay = Duration(milliseconds: 450);

  static final Map<_StudentClassroomExerciseListKey, List<ClassroomExercise>>
  _lists = <_StudentClassroomExerciseListKey, List<ClassroomExercise>>{};
  static final Map<
    _StudentClassroomExerciseListKey,
    Future<List<ClassroomExercise>>
  >
  _pendingLists =
      <_StudentClassroomExerciseListKey, Future<List<ClassroomExercise>>>{};
  static final Map<
    _StudentClassroomExerciseDetailKey,
    _StudentClassroomExerciseDetailEntry
  >
  _details =
      <
        _StudentClassroomExerciseDetailKey,
  ...
  static final Map<
    _StudentClassroomExerciseDetailKey,
    Future<ClassroomExercise?>
  >
  _pendingDetails =
      <_StudentClassroomExerciseDetailKey, Future<ClassroomExercise?>>{};
  ...
  static Future<List<ClassroomExercise>> loadList({
    ...
    final key = _StudentClassroomExerciseListKey(
  ...
  static List<ClassroomExercise>? peekList({
    ...
    return _lists[_StudentClassroomExerciseListKey(
      classroomId: classroomId,
      profileId: profileId,
      search: search,
      visibility: visibility,
  ...
  static Future<ClassroomExercise?> loadDetail({
    ...
    final key = _StudentClassroomExerciseDetailKey(
      profileId: profileId,
  ...
  static ClassroomExercise? peekFullDetail({
    ...
    final cached =
        _details[_StudentClassroomExerciseDetailKey(
          profileId: profileId,
          exerciseId: exerciseId,
        )];
  ...
  static void seedDetail({
    ...
    _details[key] = _StudentClassroomExerciseDetailEntry(
      exercise: exercise,
  ...
  static void markSubmitted({
    ...
    final updatedLists =
        <_StudentClassroomExerciseListKey, List<ClassroomExercise>>{};
    final removedKeys = <_StudentClassroomExerciseListKey>[];
...
class _StudentClassroomExerciseDetailEntry {
  const _StudentClassroomExerciseDetailEntry({
...
class _StudentClassroomExerciseListKey {
  _StudentClassroomExerciseListKey({
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is _StudentClassroomExerciseListKey &&
...
class _StudentClassroomExerciseDetailKey {
  const _StudentClassroomExerciseDetailKey({
    required this.profileId,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is _StudentClassroomExerciseDetailKey &&
            other.profileId == profileId &&
