...
import 'package:numi/features/classroom_exercise/data/classroom_exercise_conversion.dart';
...
class ClassroomExerciseApi implements ClassroomExerciseService {
  ...
  Future<List<ClassroomExercise>> listExercises({
    ...
    return _runExerciseRequest(() async {
      ...
      return response.exercises.map((exercise) => exercise.toModel()).toList();
    });
  }
  ...
  Future<ClassroomExercise?> createExercise({
    ...
    return _runExerciseRequest(() async {
      ...
      return response.exercise?.toModel();
    });
  }
