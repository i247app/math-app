...
import 'package:numi/features/classroom_exercise/screens/teacher_classroom_exercise_screen.dart';
...
import 'package:numi/features/classroom/screens/teacher_class_members_screen.dart';
...
class _TeacherClassDetailScreenState extends State<TeacherClassDetailScreen> {
                        ...
                        children: [
                          ...
                          if (detailState.errorMessage == null ||
                            ...
                            TeacherClassDetailLowerContent(
                              ...
                              onOpenAssignments: () =>
                                  _openClassroomExercise(classroom),
                              onOpenAssessments: () =>
  ...
  void _openClassroomExercise(ClassroomModel? classroom) {
    Navigator.of(context).push<void>(
      MaterialPageRoute<void>(
        builder: (_) => TeacherClassroomExerciseScreen(
          classroomId: widget.classroomId,
          profileId: widget.profileId,
